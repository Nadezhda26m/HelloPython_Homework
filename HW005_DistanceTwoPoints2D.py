...
# Алгоритм
# 1. Ввести координаты X и Y двух точек
# 2. Найти сумму квадратов разности двух соответствующих координат
# 3. Вычесть корень из полученного значения
# 4. Показать полученное растояние между точками
