...
# Алгоритм
# 1. Ввести координату X формата float
# 2. Ввести координату Y формата float
# 3. Проверить условие, что X и Y не равны 0, иначе выдать ошибку
# 4. Определить четверть на плоскости по знаку чисел
# 5. Выдать результат
